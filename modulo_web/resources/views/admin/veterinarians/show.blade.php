    ...
    <div class="show-layout">
        ...
        <x-card>
            ...
            <div class="index-toolbar" style="margin-bottom: 1rem;">
                <form method="GET" action="{{ route('admin.veterinarians.show', $veterinarian->id) }}"
                      class="search-form">
                    ...
                    @if(request('q'))
                        <a href="{{ route('admin.veterinarians.show', $veterinarian->id) }}" class="search-clear">✕
                            Limpar</a>
                    @endif
                </form>
            </div>
            ...
            <x-table :headers="['Data', 'Animal', 'Vacina Aplicada', 'Peso']">
                @foreach($vaccinations as $v)
                    <tr>
                        <td>{{ Carbon::parse($v->vaccination_date)->format('d/m/Y') }}</td>
                        <td>
