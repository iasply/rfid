...
@section('content')
<x-page-header title="Editar: {{ $vaccineType->name }}" :backLink="route('admin.vaccine-types.index')"
               backText="Voltar"/>
...
<x-card maxWidth="680px">
    <form action="{{ route('admin.vaccine-types.update', $vaccineType->id) }}" method="POST">
        ...
        <x-button type="submit" fullWidth data-testid="vaccine-type-submit" style="margin-top: 0.5rem;">Salvar
            Alterações
        </x-button>
    </form>
</x-card>
